...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-13 17:48`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9cca94ca-8221-4fb8-9eb8-4449553c7915.git
$ cd 9cca94ca-8221-4fb8-9eb8-4449553c7915
```
